...
export const JadiAnime = async (img: string, opts?: opts) => {
    ...
    return {
        ...
        videoUrl: qqmode === 'china' && extra?.video_urls ? (extra.video_urls[0] as string) : undefined,
        singleImg: qqmode === 'china' && extra?.img_urls ? (extra.img_urls[2] as string) : undefined, 
    }
};
